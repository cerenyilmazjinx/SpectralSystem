// src/lib.rs
/*
 * Core library for SpectralSystem
 */
...
#[derive(Debug)]
pub struct SpectralSystemProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SpectralSystemProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SpectralSystem processing");
    
    let mut processor = SpectralSystemProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SpectralSystemProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SpectralSystemProcessor::new(false);
